...
<div id="searchForm">
	<div class="span-18">
		<spring:hasBindErrors name="searchpatient">
			<div class="error">
				<spring:bind path="searchpatient.*">
		...
		<form:form modelAttribute="searchpatient">
			<fieldset>
				...
				<div>
					...
					<div class="span-3">
						<label for="startYear">Earliest year arrived:</label>
					</div>
					<div class="span-4 last">
				...
				<tbody>
					<c:forEach var="patient" items="${patientList}">
						<tr>
							...
							<td>${patient.lname}</td>
							<td>${patient.p_id}</td>
							<td>${patient.ident.dis}</td>
							<td><fmt:formatDate value="${patient.arrived}" type="both" pattern="MM/dd/yyyy" /></td>
							<td><a href="editpatient/${patient.p_id}">Edit Patient</a></td>
						</tr>
					</c:forEach>
